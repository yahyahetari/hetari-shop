...
export default function ProductBox({ _id, title, description, images, price, category, properties, product }) {
  ...
  return (
    <motion.div 
      className="flex flex-col gap-1 mt-3 mb-3 border border-slate-800 rounded-lg"
      initial={{ opacity: 0, y: -50 }} // Start from 50px above and fully transparent
      animate={{ opacity: 1, y: 0 }} // Animate to its original position and full opacity
      ...
      <Link href={`/product/${_id}`}>
        <div className="relative overflow-hidden group">
          <img
            ...
            width={250}
            height={300}
            className="w-[150px] h-[160px] sm:w-[150px] sm:h-[170px] md:w-[180px] md:h-[200px] lg:w-[180px] lg:h-[200px] xl:w-[200px] xl:h-[220px] rounded-md m-1.5 transition-transform duration-300 group-hover:scale-105 bg-white object-cover cursor-pointer"
            />
