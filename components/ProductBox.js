      ...
      <Link href={`/product/${_id}`}>
        <div className="relative overflow-hidden group">
          <img
            ...
            width={250}
            height={300}
            className="w-[140px] h-[160px] sm:w-[150px] sm:h-[170px] md:w-[180px] md:h-[200px] lg:w-[180px] lg:h-[200px] xl:w-[200px] xl:h-[220px] rounded-md m-1.5 transition-transform duration-300 group-hover:scale-105 bg-white object-cover cursor-pointer"
            />
